...
#
get_filename_component(filename "/home/runner/work/RUFUS/RUFUS/src/modifiedJellyfish.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/RUFUS/RUFUS/_codeql_build_dir/externals/modified_jellyfish/src/modified_jellyfish_project" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-modified_jellyfish_project${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-modified_jellyfish_project${i}")
