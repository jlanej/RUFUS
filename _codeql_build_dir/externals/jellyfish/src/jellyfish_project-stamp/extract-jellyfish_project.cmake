...
#
get_filename_component(filename "/home/runner/work/RUFUS/RUFUS/_codeql_build_dir/externals/jellyfish/src/jellyfish-2.2.5.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/RUFUS/RUFUS/_codeql_build_dir/externals/jellyfish/src/jellyfish_project" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-jellyfish_project${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-jellyfish_project${i}")
